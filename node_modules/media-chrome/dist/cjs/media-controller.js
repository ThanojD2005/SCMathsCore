  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === Attributes.NO_HOTKEYS) {
      ...
      (_j = __privateGet(this, _mediaStore)) == null ? void 0 : _j.dispatch({
        type: import_constants.MediaUIEvents.MEDIA_LOOP_REQUEST,
  ...
  keyboardShortcutHandler(e) {
    ...
    switch (e.key) {
      ...
      case "<": {
        ...
        evt = new import_server_safe_globals.globalThis.CustomEvent(import_constants.MediaUIEvents.MEDIA_PLAYBACK_RATE_REQUEST, {
          composed: true,
          bubbles: true,
          detail
        });
      ...
      case "p": {
        eventName = this.mediaStore.getState().mediaIsPip ? import_constants.MediaUIEvents.MEDIA_EXIT_PIP_REQUEST : import_constants.MediaUIEvents.MEDIA_ENTER_PIP_REQUEST;
        evt = new import_server_safe_globals.globalThis.CustomEvent(eventName, {
          composed: true,
          bubbles: true
        });
        this.dispatchEvent(evt);
...
keyDownHandler_fn = function(e) {
  ...
  this.addEventListener("keyup", __privateGet(this, _keyUpHandler), { once: true });
};
...
showKeyboardShortcutsDialog_fn = function() {
  if (!__privateGet(this, _keyboardShortcutsDialog)) {
    __privateSet(this, _keyboardShortcutsDialog, import_server_safe_globals.document.createElement(
